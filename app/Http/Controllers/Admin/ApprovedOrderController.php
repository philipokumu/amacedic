...
class ApprovedOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.order.approved.index', compact('approvedOrders'));
    }
    ...
    public function show(Order $order)
    {
        if ($order->status == 'approved') {
            ...
            return view('admin.order.approved.show', compact('approvedOrder','inrevisionInstructions','messages','deadline','writerDeadline','historyOrders'));
