@extends('layouts.app', ['activePage' => 'New-Order', 'title' => __('Make Order'), 'titlePage' => __('Make Order')])
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 py-5">
          <div class="card">
              <form method="POST" action="{{ route('user.order.confirm') }}" id="createOrder" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" id="ordercreate">
              @csrf
      
              <div class="card-header card-header-primary">
                <h4 class="card-subjectArea">{{ __('Order details') }}</h4>
                <p class="card-category">{{ __('We guarantee you HIGH QUALITY writing') }}</p>
              </div>
              <div class="card-body ">
                              
              @include('forms/neworder/ordercreate')
            ...
            {{-- </form> --}}
                ...
                @guest
                <hr class="signup-login"/>
  
                <div class="tim-type signup-login">
                  <h3>Signup | Login</h3>
                </div>
              ...
              <!--start tabs-->
              <ul class="nav nav-pills nav-pills-primary signup-login" role="tablist">
                <!-- Tab 1 menu -->
                <li class="nav-item">
      ...
      <div class="tab-content tab-space signup-login">
        <!-- New customer start | Tab 1 content -->
            
        <!-- start testing register authentication-->
          <div class="tab-pane active" id="link1">
            <form class="form-r-l" method="POST" action="{{ route('register') }}" id="register">
              @csrf
              @if (isset($referredBy)) 
              ...
              @endif
              <div class="card card-register card-hidden mb-3">
                <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                  <div class="input-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="{{ __('Name...') }}" value="{{ old('name') }}" required maxlength="30">
                  </div>
                  @if ($errors->has('name'))
                  ...
                  @endif
                    <div id="reg-name-error" class="error text-danger pl-3" for="name" style="display: block;"></div>
                    <div id="reg-ip-error" class="error text-danger pl-3" for="ip" style="display: block;"></div>
                </div>
                ...
                <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }} mt-3">
                  ...
                  @endif
                  <div id="reg-email-error" class="error text-danger pl-3" for="email" style="display: block;"></div>
                </div>
                <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
                  ...
                  @endif
                  <div id="reg-password-error" class="error text-danger pl-3" for="password" style="display: block;"></div>
                </div>
                <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
                  ...
                  @endif
                  <div id="password_confirmation-error" class="error text-danger pl-3" for="password_confirmation" style="display: block;"></div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-prepend">
                    <select class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" title="-Select your country-" name="country" id="country" type="country" value="{{ old('country') }}" required >
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }} col-sm-6">
                      <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="number" placeholder="{{ __('+1 234 567 890') }}" value="{{ old('phone')}}" required="true" aria-required="true"/>
                      @if ($errors->has('phone'))
                ...
                <span id="g-error" class="error text-danger" for="input-g-recaptcha">{{ $errors->first('g-recaptcha') }}</span>
                ...
                <div class="card-footer ml-auto mr-auto">
                  <button type="submit" class="btn btn-primary submit-l-r" data-field="register" value="register">{{ __('Make order')}}</button>
                </div>
              </div>
            </form>
          </div>
          <!-- end testing register authentication-->
          <!-- New customer end | Tab 1 end-->      
          
              <!-- Tab 2 content -->
              <div class="tab-pane" id="link2">
                  <!-- Login start -->

                  <form class="form-r-l" method="POST" action="{{ route('login') }}" id="login">
                    @csrf
                    ...
                    <div class="card py-3">
                      <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        @endif
                        <span id="email-error" class="error text-danger pl-3" for="email" style="display: block;"></span>
                      </div>
                      <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
                        <div class="input-group">
                          <div class="input-group-prepend">
                        ...
                        @endif
                        <span id="password-error" class="error text-danger pl-3" for="password" style="display: block;"></span>
                      </div>
                      
                      <div class="row">
                        <div class="form-group mr-auto ml-3 mt-3">
                      ...
                      <div class="card-footer ml-auto mr-auto">
                        <button type="submit" class="btn btn-primary submit-l-r" data-field="login" value="login">{{ __('Make order') }}</button>
                      </div>
                    </div>
