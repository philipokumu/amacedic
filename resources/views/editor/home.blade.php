...
@extends('editor.layouts.app', ['activePage' => 'dashboard', 'titlePage' => __('Dashboard')])
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            ...
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons">access_time</i>
                <a href="{{route('editor.approved.index')}}">View order(s)</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            ...
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons">access_time</i>
                <a href="{{route('editor.cancelled.index')}}">View order(s)</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card card-stats">
              ...
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons">access_time</i>
                  <a href="{{route('editor.message.index')}}">View message(s)</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card card-stats">
              ...
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons">access_time</i>
                  <a href="{{route('editor.completed.index')}}">View order(s)</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12">
            <div class="card card-stats">
              ...
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons">access_time</i>
                  <a href="{{route('editor.invoice.index')}}">Go to invoice(s)</a>
                </div>
              </div>
            </div>
          </div>  
