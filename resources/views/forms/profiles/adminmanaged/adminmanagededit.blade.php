...
<div class="tab-content">
  <div class="tab-pane active" id="accountinfo">
    <form method="post" action="{{ route('admin'.'.'.$owner.'.'.'update',$profile) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
      @csrf
      @method('put')
      <div class="col-md-12">
        <div class="card-body ">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Name') }}" value="{{ old('name', $profile->name) }}" required="true" aria-required="true"/>
                @if ($errors->has('name'))
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('email', $profile->email) }}" required />
                @if ($errors->has('email'))
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                <select class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" id="input-status" type="text" placeholder="{{ __('status') }}" required="true" aria-required="true">
                  ...
                  <option value="active" @if (old('status')=='active') selected @elseif ($profile->status=='active') selected @endif>Active</option>
                  <option value="inactive" @if (old('status')=='inactive') selected  @elseif ($profile->status=='inactive') selected @endif>Inactive</option>
                </select>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('nickname') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('nickname') ? ' is-invalid' : '' }}" name="nickname" id="input-nickname" type="text" placeholder="{{ __('nickname') }}" value="{{ old('nickname', $profile->nickname) }}" maxlength="15"/>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('country') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" name="country" id="input-country" type="text" placeholder="{{ __('country') }}" value="{{ old('country', $profile->country) }}" required="true" aria-required="true"/>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="text" placeholder="{{ __('phone') }}" value="{{ old('phone', $profile->phone) }}" required="true" aria-required="true"/>
                @if ($errors->has('phone'))
    ...
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{ route('admin'.'.'.$owner.'.'.'password',$profile) }}" class="form-horizontal">
          @csrf
          @method('put')
  ...
  @if (($owner=='editor')||($owner=='writer'))
    <div class="tab-pane" id="education">
      <div class="col-md-12">
        <form method="post" action="{{ route('admin'.'.'.$owner.'.'.'education',$profile) }}" autocomplete="off" class="form-horizontal">
          @csrf
          @method('put')
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('educationLevel') ? ' has-danger' : '' }}">
                  <select class="form-control{{ $errors->has('educationLevel') ? ' is-invalid' : '' }}" name="educationLevel" id="input-educationLevel" type="text" required="true" aria-required="true">
                    ...
                    <option value="highschool" @if (old('educationLevel')=='highschool') selected @elseif ($profile->educationLevel=='highschool') selected @endif>High school</option>
                    <option value="undergraduate" @if (old('educationLevel')=='undergraduate') selected @elseif ($profile->educationLevel=='undergraduate') selected @endif>Under graduate</option>
                    <option value="postgraduate" @if (old('educationLevel')=='postgraduate') selected @elseif ($profile->educationLevel=='postgraduate') selected @endif>Post graduate</option>
                    <option value="masters" @if (old('educationLevel')=='masters') selected @elseif ($profile->educationLevel=='masters') selected @endif>Masters</option>
                    <option value="PHD" @if (old('educationLevel')=='PHD') selected @elseif ($profile->educationLevel=='PHD') selected @endif>PHD</option>
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('bio') ? ' has-danger' : '' }}">
                  <textarea class="form-control{{ $errors->has('bio') ? ' is-invalid' : '' }}" rows="5" name="bio" id="input-bio" type="text" placeholder="{{ __('My bio') }}" required="true" aria-required="true">{{ old('bio', $profile->bio)}}</textarea>
                  @if ($errors->has('bio'))
  ...
  @if ($owner!='client')
    <div class="tab-pane" id="payment">
      <div class="col-md-12">
        <form method="post" action="{{ route('admin'.'.'.$owner.'.'.'payment',$profile) }}" autocomplete="off" class="form-horizontal">
          @csrf
          @method('put')
          <div class="card-body ">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('accountType') ? ' has-danger' : '' }}">
                  <select class="form-control{{ $errors->has('accountType') ? ' is-invalid' : '' }}" name="accountType" id="input-accountType" type="text" placeholder="{{ __('accountType') }}" required="true" aria-required="true">
                    ...
                    <option value="bank" @if (old('accountType')=='bank') selected @elseif ($profile->accountType=='bank') selected @endif>Bank</option>
                    <option value="mpesa" @if (old('accountType')=='mpesa') selected @elseif ($profile->accountType=='mpesa') selected @endif>Mpesa</option>
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('bankName') ? ' has-danger' : '' }}">
                  <input class="form-control{{ $errors->has('bankName') ? ' is-invalid' : '' }}" name="bankName" id="input-bankName" type="text" placeholder="{{ __('Only if your selected account type is bank. Leave empty otherwise') }}" value="{{ old('bankName', $profile->bankName) }}"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('accountName') ? ' has-danger' : '' }}">
                  <input class="form-control{{ $errors->has('accountName') ? ' is-invalid' : '' }}" name="accountName" id="input-accountName" type="text" placeholder="{{ __('Bank or Mpesa name') }}" value="{{ old('accountName', $profile->accountName) }}" required="true" aria-required="true"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group{{ $errors->has('accountNumber') ? ' has-danger' : '' }}">
                  <input class="form-control{{ $errors->has('accountNumber') ? ' is-invalid' : '' }}" name="accountNumber" id="input-accountNumber" type="text" placeholder="{{ __('Bank or Mpesa number') }}" value="{{ old('accountNumber', $profile->accountNumber) }}" required="true" aria-required="true"/>
