@extends('admin.layouts.app', ['activePage' => 'New-Order', 'title' => __('Order'), 'titlePage' => __('Order')])
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 py-5">
          <div class="card">
            <form method="POST" action="{{ route('order.confirm') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" id="orderform">
              {{-- <input name="csrf-token" type="hidden" content={{ csrf_field()}} > --}}
              @csrf
      
              <div class="card-header card-header-primary">
                <h4 class="card-subjectArea">{{ __('Edit Profile') }}</h4>
            ...
            <form class="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-check mr-auto ml-3 mt-3">
                  <label class="form-check-label">
                    ...
                    {{ __('I agree with the ') }} <a href="#">{{ __('Privacy Policy') }}</a>
                      ...
                      <div class="col-sm-4">
                        <input type="number" class="form-control" placeholder="+1 202 001 001">
                      </div>
                      </div>-->
                    <div class="card-footer ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary submit">{{ __('Make order') }}</button>
                    </div>
              ...
              <div class="tab-pane" id="link2">
                  ...
                  <form class="form" method="POST" action="{{ route('login') }}" id="login">
                    {{-- <input name="csrf-token" content="{{ csrf_token() }}" type="hidden"> --}}
                    ...
                    <div class="card-body">
                      <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        <div class="input-group">
                          ...
                          <input type="email" name="email" class="form-control col-sm-7" placeholder="{{ __('Email...') }}" value="{{ old('email')}}" required>
                        </div>
                        @if ($errors->has('email'))
                          <div id="email-error" class="error text-danger pl-3" for="email" style="display: block;">
                            <strong>{{ $errors->first('email') }}</strong>
                      ...
                      <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
                        <div class="input-group">
                          ...
                          <input type="password" name="password" id="password" class="form-control col-sm-7" placeholder="{{ __('Password...') }}" value="{{ old('password')}}" required>
                        </div>
                        @if ($errors->has('password'))
                          <div id="password-error" class="error text-danger pl-3" for="password" style="display: block;">
                            <strong>{{ $errors->first('password') }}</strong>
