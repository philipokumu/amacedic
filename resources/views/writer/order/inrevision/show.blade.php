...
@extends('writer.layouts.app', ['activePage' => 'In-revision', 'titlePage' => __('Inrevision order')])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary row">
            ...
            <span class="col-6">
              <a href="{{route('writer.inrevision.index')}}" class='btn btn-info pull-right'>Back to list</a>
            </span>
          </div>
              ...
              <tr>
                <th>
                    <span class="pull-right">
                        <form method="POST" action="{{route('writer.inrevision.update',$inrevisionOrder)}}" class="form-horizontal">
                          @csrf
                          @method('PATCH')
