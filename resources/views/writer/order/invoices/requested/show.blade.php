...
@extends('writer.layouts.app', ['activePage' => 'Invoice', 'titlePage' => __('Requested invoice')])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary row">
            ...
            <span class="col-6">
              <a href="{{route('writer.invoice.index')}}" class='btn btn-info pull-right'>Back to Invoices</a>
            </span>
          </div>
